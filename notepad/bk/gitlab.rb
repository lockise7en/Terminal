...
external_url 'http://gitlab.lockyse7en.com'
...
gitlab_rails['trusted_proxies'] = [ '192.168.168.0/24', '127.0.0.0/24' ]
...
{
      "name" => "github",
      "app_id" => "0174f915ab63d093763c",
      "app_secret" => "9927fbd163c8e31359b2650d916946c3762cba5b",
      "args" => { "scope" => "lockyse7en:lockyse7en@outlook.com" }
    }
...
registry_external_url 'https://gitlab.lockyse7en.com'

# ### Settings used by GitLab application
gitlab_rails['registry_enabled'] = true
gitlab_rails['registry_host'] = "gitlab.lockyse7en.com"
gitlab_rails['registry_port'] = "5000"
gitlab_rails['registry_path'] = "/var/opt/gitlab/registry"
registry_nginx['ssl_certificate'] = "/home/gitlab/certs/server.crt"
registry_nginx['ssl_certificate_key'] = "/home/gitlab/certs/server.key"
# ###! **Do not change the following 3 settings unless you know what you are
# ###!   doing**
# gitlab_rails['registry_api_url'] = "http://192.168.168.5:5000"
# gitlab_rails['registry_key_path'] = "/home/gitlab/certs/lockyse7en.com.key"
...
# #registry['env_directory'] = "/opt/gitlab/etc/registry/config.yml"
# #registry['env'] = {}
# registry['log_level'] = "info"
# registry['rootcertbundle'] = "/opt/gitlab/etc/registry/ca.crt"
...
# gitlab_workhorse['auth_backend'] = "http://192.168.168.5:8080"
...
# gitlab_workhorse['prometheus_listen_addr'] = "192.168.168.5:9229"
...
# sidekiq['listen_address'] = "192.168.168.5"
...
# nginx['ssl_certificate'] = "/home/gitlab/certs/1523292795823.crt"
# nginx['ssl_certificate_key'] = "/home/gitlab/certs/1523292795823.key"
...
#    "allow" => "127.0.0.1", # Only allow access from 192.168.168.5
...
pages_external_url "http://pages.lockyse7en.com/"
gitlab_pages['enable'] = true
#! Configure to expose GitLab Pages on external IP address, serving the HTTP
gitlab_pages['external_http'] = ['http://192.168.168.5']

#! Configure to expose GitLab Pages on external IP address, serving the HTTPS
gitlab_pages['external_https'] = ['https://192.168.168.5']
...
# prometheus['listen_address'] = '192.168.168.5:9090'
...
##! Advanced settings. Should be changed only if absolutely needed.
# alertmanager['listen_address'] = '192.168.168.5:9093'
...
##! Advanced settings. Should be changed only if absolutely needed.
# node_exporter['listen_address'] = '192.168.168.5:9100'
...
##! Advanced settings. Should be changed only if absolutely needed.
# redis_exporter['listen_address'] = '192.168.168.5:9121'
...
# postgres_exporter['listen_address'] = '192.168.168.5:9187'
...
# pgbouncer-exporter['listen_address'] = '192.168.168.5:9188'
...
##! Advanced settings. Should be changed only if absolutely needed.
# gitlab_monitor['listen_address'] = '192.168.168.5'
...
# gitaly['listen_addr'] = "192.168.168.5:8075"
# gitaly['prometheus_listen_addr'] = "192.168.168.5:9236"
