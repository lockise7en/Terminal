...
case $(uname -m) in
  armv7l)
    ...
    INST_URL='http://192.168.168.2/repo/entware/binaries/armv7/installer/entware_install.sh'
    ;;
  mips)
    PART_TYPES='ext2|ext3'
    INST_URL='http://192.168.168.2/repo/entware/binaries/mipsel/installer/installer.sh'
    ;;
  *)
