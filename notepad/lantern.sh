...
exec "$LANTERN_USER_BINARY"  "$@" "uiaddr:0.0.0.0:8787 clear-proxy-settings:true headless:false proxyall:false readableconfig:true socksaddr:0.0.0.0:8687 startup:true"
