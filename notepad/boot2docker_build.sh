...
export KERNEL_VERSION  4.9.93

# Fetch the kernel sources
curl --retry 10 https://cdn.kernel.org/pub/linux/kernel/v${KERNEL_VERSION%%.*}.x/linux-$KERNEL_VERSION.tar.xz | tar -C / -xJ && \
	mv /linux-$KERNEL_VERSION /linux-kernel

# http://aufs.sourceforge.net/
export AUFS_REPO=https://github.com/sfjro/aufs4-standalone
export AUFS_BRANCH=aufs4.9
export AUFS_COMMIT=b5eed3ecdd1deaacd0bce1d3a524b1542407c40d
...
# Install libcap
curl -fL http://http.debian.net/debian/pool/main/libc/libcap2/libcap2_2.22.orig.tar.gz | tar -C / -xz && \
cd /libcap-2.22 && \
...
export AUFS_UTIL_REPO=https://git.code.sf.net/p/aufs/aufs-util
export AUFS_UTIL_BRANCH=aufs4.9
export AUFS_UTIL_COMMIT=568636e5c45006b1e6e0c4b704401610a02c0089
set -ex \
...
export TCL_REPO_BASE=http://distro.ibiblio.org/tinycorelinux/8.x/x86_64
export TCL_REPO_FALLBACK=http://tinycorelinux.net/8.x/x86_64
...
export VBOX_VERSION 5.2.2
#   https://www.virtualbox.org/download/hashes/$VBOX_VERSION/SHA256SUMS
export VBOX_SHA256 8317a0479a94877829b20a19df8a7c09187b31eecb3f1ed9d2b8cb8681a81bb8
...
# Build VMware Tools
export OVT_VERSION 10.0.0-3000743

curl --retry 10 -fsSL "https://github.com/vmware/open-vm-tools/archive/open-vm-tools-${OVT_VERSION}.tar.gz" | tar -xz --strip-components=1 -C /
...
# Horrible hack again
ln -sT libdnet.1 "$ROOTFS/usr/local/lib/libdumbnet.so.1" \
...
ln -sT libtirpc.so "$ROOTFS/usr/local/lib/libtirpc.so.1" \
...
export PRL_MAJOR 13
export PRL_VERSION 13.3.0-43321
...
export XEN_REPO https://github.com/xenserver/xe-guest-utilities
export XEN_VERSION v6.6.80
...
find "$ROOTFS/etc/rc.d/" "$ROOTFS/usr/local/etc/init.d/" -type f -exec chmod --changes +x '{}' +
